    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            if (authError) {
                ...
                // সফল হলে ২ সেকেন্ড পর রিডাইরেক্ট হবে (যাতে ব্যবহারকারী Success মেসেজটি দেখতে পান)
                setTimeout(() => {
                    router.push("/"); // আপনার কাঙ্ক্ষিত রুটটি এখানে দিন (যেমন: /dashboard বা /)
                }, 2000);
            }
        } catch (err) {
